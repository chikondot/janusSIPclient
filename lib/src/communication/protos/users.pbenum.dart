...
class UserStatus extends $pb.ProtobufEnum {
  static const UserStatus SUSPENDED = UserStatus._(0, 'SUSPENDED');
  static const UserStatus UNSUBSCRIBED = UserStatus._(1, 'UNSUBSCRIBED');
  static const UserStatus SUBSCRIBED = UserStatus._(2, 'SUBSCRIBED');
